...
static void fill_dummy_signature(char *sig, int size)
{
    struct am335x_baseboard_id *header = (struct am335x_baseboard_id *)sig;
...
static int bone_baseboard_scan(struct bone_baseboard *bbrd)
{
	...
	fill_dummy_signature(bbrd->signature, sizeof(bbrd->signature));
